...
branches:
  ...
  # NOTE: I really recommend you using commit SHA because if you create tag with this message all objects will be created from the last commit of target branch.
  projects:
    main: &main [ 2, 3 ]
